...
def train_random_forest():
    """
    Train and evaluate a random forest model for health status prediction
    """
    # Load preprocessed data from CSV files
    ...
    cv_scores = cross_val_score(rf_model, data['X_train_scaled'], data['y_train'], cv=5)
    ...
    # Make predictions
    y_pred = rf_model.predict(data['X_test_scaled'])
    ...
    return rf_model, data['imputer'], data['scaler']
...
if __name__ == "__main__":
    ...
    model, imputer, scaler = train_random_forest()
